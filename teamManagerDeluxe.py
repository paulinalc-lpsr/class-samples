...
print("Welcome to the new and improved FIFA 133!")
class Player(object):
...
# this saves the players list to a file
                ...
                print("Enter the name of the file you want to add your players to, make sure to ad$
                newFile = raw_input()
                saveTeam(myPlayers, newFile)
# when the user put in 0, this message will appear
print("Hope you enjoyed making your drean team!")
